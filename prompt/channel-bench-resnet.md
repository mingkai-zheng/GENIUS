...
Your objective is to define the optimal number of channels for each layer based on the given options above to maximize the model's performance on CIFAR10. Your response should be the a channel list consisting of 7 numbers (e.g. [64, 192, ..., 256]).

Here are some experimental results that you can use as a reference:
[64, 128, 128, 256, 384, 256, 384] gives an accuracy of 92.67%
